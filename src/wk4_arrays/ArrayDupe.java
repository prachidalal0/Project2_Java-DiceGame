...
public class ArrayDupe {
	...
	public static void main(String[] args) {
		...
		/*
		Copy ArrayRandom3 to ArrayDupe
		Declare a boolean value, dupe, initialize to false
		Implement a method, isDupe, that checks for duplicate values in the array
		Returns boolean true if dupe found, false if not found
		Invoke the method after the array is sorted
		Print the value of the var dupe
		*/
	...
	public static boolean isDupe(int[] array) {
		...
		for (int i = 0; i < array.length - 1; i++) {
			/* array.length - 1 to take out out of bounds exception (for when 
			it is false)
